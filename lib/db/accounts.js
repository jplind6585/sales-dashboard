...
export async function getAccounts(userId) {
  ...
  const cols = 'id, name, stage, tier, owner_name, hubspot_deal_id, deal_value, close_date, created_at, updated_at, user_id, hubspot_synced_at, competitor1, competitor2, risk_score, risk_factors, risk_scored_at'
  const PAGE = 1000
  let accounts = []
