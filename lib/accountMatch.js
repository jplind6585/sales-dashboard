...
// Pick the best account for a title from a list of {id,name,stage}. Returns {id,name,score} or null.
export function bestAccountForTitle(title, accounts = []) {
  ...
  for (const account of accounts) {
    const score = extracted ? scoreMatch(account.name, extracted, true) : scoreMatch(account.name, title, false);
