...
// Active pipeline reads as one coral tint ramp (light early → deep late); closed_won is the
// only green; closed_lost + inactive are muted grey (never alarm-red). Badge = tailwind classes.
export const STAGE_COLORS = {
  qualifying:              'bg-slate-100 text-slate-600',
  intro_scheduled:         'bg-coral-50 text-coral-700',
  active_pursuit:          'bg-coral-100 text-coral-700',
  demo:                    'bg-coral-100 text-coral-800',
  solution_validation:     'bg-coral-200 text-coral-800',
  proposal:                'bg-coral-200 text-coral-900',
  legal:                   'bg-navy text-white',
  inactive_sdr_follow_up:  'bg-slate-100 text-slate-400',
  inactive_ae_follow_up:   'bg-slate-100 text-slate-400',
  closed_won:              'bg-emerald-100 text-emerald-700',
  closed_lost:             'bg-slate-100 text-slate-400',
}

// Hex ramp for charts/bars — same single coral system so every funnel/stage bar matches.
export const STAGE_HEX = {
  qualifying:              '#CBD5E1',
  intro_scheduled:         '#F7B3A6',
  active_pursuit:          '#F2907D',
  demo:                    '#F06E55',
  solution_validation:     '#EE5340',
  proposal:                '#E23F2B',
  legal:                   '#16202E',
  inactive_sdr_follow_up:  '#CBD5E1',
  inactive_ae_follow_up:   '#CBD5E1',
  closed_won:              '#2FBF71',
  closed_lost:             '#94A3B8',
}
