...
import {
  ...
  Settings, LayoutGrid, Trophy, Sparkles, ClipboardCheck, Search, GraduationCap, Handshake,
} from 'lucide-react';
...
export const MODULES = [
  ...
  { key: 'work-requests', label: 'Work Requests', href: '/modules/work-requests', icon: Handshake, group: 'Work', color: 'text-coral-600', desc: 'Ask design / sales engineering — account context attached', nav: true, grid: true },
  // Pipeline
