...
export const GROUPS = ['Work', 'Pipeline', 'Intelligence', 'Analytics', 'Admin'];
...
export const MODULES = [
  ...
  // Reports
  { key: 'sales-reports', label: 'Analytics', href: '/modules/sales-reports', icon: BarChart2, group: 'Analytics', color: 'text-navy', desc: 'All report dashboards + exec view', nav: true, grid: true, minRole: 'manager' },
  { key: 'command-center', label: 'Command Center', href: '/modules/sales-reports/command-center', icon: Gauge, group: 'Analytics', color: 'text-coral-600', desc: 'Revenue/pipeline vs goal + live feed', nav: false, grid: true },
  { key: 'ceo-dashboard', label: 'CEO Dashboard', href: '/modules/sales-reports/ceo-dashboard', icon: TrendingUp, group: 'Analytics', color: 'text-coral-500', desc: 'The one exec view: $ pipeline, win rate, forecast', nav: false, grid: true, minRole: 'manager' },
  { key: 'roi-tracker', label: 'ROI Tracker', href: '/modules/roi-tracker', icon: TrendingUp, group: 'Analytics', color: 'text-coral-600', desc: 'What each investment returns — pipeline, revenue, payback', nav: false, grid: true },
  { key: 'team-dashboard', label: 'Team Dashboard', href: '/modules/sales-reports/team-dashboard', icon: Users, group: 'Analytics', color: 'text-navy', desc: 'Per-rep scorecards + pipeline', nav: false, grid: true },
  { key: 'call-registry', label: 'Call Registry', href: '/modules/sales-reports/call-registry', icon: Database, group: 'Analytics', color: 'text-navy', desc: 'Every call, searchable', nav: false, grid: true },
  { key: 'activity-leaderboard', label: 'Activity Leaderboard', href: '/modules/sales-reports/activity-leaderboard', icon: Trophy, group: 'Analytics', color: 'text-coral-500', desc: 'SDR/AE activity ranking', nav: false, grid: true },
  { key: 'lead-intelligence', label: 'Lead Intelligence', href: '/modules/sales-reports/lead-intelligence', icon: Search, group: 'Analytics', color: 'text-navy', desc: 'Multi-year lead funnel', nav: false, grid: true },
  { key: 'data-validation', label: 'Data Validation', href: '/modules/sales-reports/data-validation', icon: ClipboardCheck, group: 'Analytics', color: 'text-navy', desc: 'Lead/deal data checks', nav: false, grid: true },
  { key: 'hubspot-audit', label: 'HubSpot Audit', href: '/modules/sales-reports/hubspot-audit', icon: Database, group: 'Analytics', color: 'text-navy', desc: 'Sync log', nav: false, grid: true },
  // Admin
  { key: 'sales-processes', label: 'Sales Processes', href: '/modules/sales-processes', icon: Sliders, group: 'Admin', color: 'text-coral-600', desc: 'ICP, discovery, stage-exit criteria', nav: true, grid: true, minRole: 'manager' },
  { key: 'playbooks', label: 'Playbooks', href: '/modules/playbooks', icon: ClipboardCheck, group: 'Admin', color: 'text-coral-500', desc: 'Pre/post-call checklists that auto-create tasks', nav: true, grid: true },
  { key: 'data-quality', label: 'Data Quality', href: '/modules/data-quality', icon: AlertTriangle, group: 'Admin', color: 'text-amber-600', desc: 'Low-confidence links, dedup, cleanup', nav: true, grid: true, minRole: 'manager' },
  { key: 'users', label: 'Users & Roles', href: '/modules/users', icon: Users, group: 'Admin', color: 'text-coral-600', desc: 'Assign roles and rep type', nav: true, grid: true, minRole: 'admin' },
