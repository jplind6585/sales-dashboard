...
import {
  ...
  Settings, LayoutGrid, Trophy, Sparkles, ClipboardCheck, Search, GraduationCap, Wrench,
} from 'lucide-react';
...
export const MODULES = [
  ...
  { key: 'coaching-lab', label: 'Coaching Lab', href: '/modules/coaching-lab', icon: GraduationCap, group: 'Intelligence', color: 'text-coral-500', desc: 'Best calls to learn from + deals to advance-or-kill', nav: true, grid: true },
  ...
  { key: 'roi-tracker', label: 'ROI Tracker', href: '/modules/roi-tracker', icon: TrendingUp, group: 'Reports', color: 'text-coral-600', desc: 'What each investment returns — pipeline, revenue, payback', nav: true, grid: true },
