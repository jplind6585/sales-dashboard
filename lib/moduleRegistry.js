...
export const MODULES = [
  ...
  { key: 'work-requests', label: 'Work Requests', href: '/modules/work-requests', icon: Wrench, group: 'Work', color: 'text-coral-600', desc: 'Ask design / sales engineering — account context attached', nav: true, grid: true },
  ...
  { key: 'prospecting', label: 'Prospecting', href: '/modules/prospecting', icon: Search, group: 'Pipeline', color: 'text-coral-600', desc: 'Apollo search + enrich, review, add to pipeline', nav: true, grid: true },
  ...
  // Reports
  { key: 'sales-reports', label: 'Sales Reports', href: '/modules/sales-reports', icon: BarChart2, group: 'Reports', color: 'text-navy', desc: 'All report dashboards', nav: true, grid: true, minRole: 'manager' },
  { key: 'command-center', label: 'Command Center', href: '/modules/sales-reports/command-center', icon: Gauge, group: 'Reports', color: 'text-coral-600', desc: 'Revenue/pipeline vs goal + live feed', nav: false, grid: true },
  { key: 'ceo-dashboard', label: 'CEO Dashboard', href: '/modules/sales-reports/ceo-dashboard', icon: TrendingUp, group: 'Reports', color: 'text-coral-500', desc: 'The one exec view: $ pipeline, win rate, forecast', nav: true, grid: true, minRole: 'manager' },
  { key: 'roi-tracker', label: 'ROI Tracker', href: '/modules/roi-tracker', icon: TrendingUp, group: 'Reports', color: 'text-coral-600', desc: 'What each investment returns — pipeline, revenue, payback', nav: false, grid: true },
  { key: 'team-dashboard', label: 'Team Dashboard', href: '/modules/sales-reports/team-dashboard', icon: Users, group: 'Reports', color: 'text-navy', desc: 'Per-rep scorecards + pipeline', nav: false, grid: true },
  { key: 'call-registry', label: 'Call Registry', href: '/modules/sales-reports/call-registry', icon: Database, group: 'Reports', color: 'text-navy', desc: 'Every call, searchable', nav: false, grid: true },
  { key: 'activity-leaderboard', label: 'Activity Leaderboard', href: '/modules/sales-reports/activity-leaderboard', icon: Trophy, group: 'Reports', color: 'text-coral-500', desc: 'SDR/AE activity ranking', nav: false, grid: true },
