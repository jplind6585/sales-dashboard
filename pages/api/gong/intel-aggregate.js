...
export default async function handler(req, res) {
  ...
  if (req.method === 'GET') {
    ...
    const aggregatePrompt = `You are analyzing ${rows.length} sales calls (Intro and Demo) for Banner, a CapEx management software company for commercial real estate.
...
Return ONLY valid JSON with this aggregate analysis:
{
  ...
  "top_themes": [{"theme": "theme name", "count": 8}],
  ...
  "rep_stats": [{"rep": "name", "call_count": 5, "avg_talk_ratio": 45, "positive_pct": 60, "top_objection": "pricing"}],
