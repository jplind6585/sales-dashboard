...
import {
  ...
  Target, BarChart3, CheckCircle2, ChevronDown, ChevronUp, Database, Gauge, FileText, Phone,
} from 'lucide-react'
...
const QUICK_MODULES = [
  ...
  { label: 'Call Queue', href: '/modules/call-queue', icon: Phone, color: 'text-emerald-600' },
