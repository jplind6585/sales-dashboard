...
- **Now starting Wave 3 (UX+rebrand):** ⌘K palette (3.1), tasks toolbar (3.2), inline task actions (3.3), call-queue outcome (3.5), last-call rows (3.7), queue merge (1.6/3.8), timeline tab (1.3), touch consolidation (1.4/2.10), pursuit/outbound→Supabase (1.7), apply brand + persistent nav (5.x/3.4), kill Live pill (5.7), chart fixes (5.6). Then Wave 4 (coaching/process), 5 (systems+moonshots), Integrations, Big test.
