...
- **~34 of ~61 items + 2 systems + 1 moonshot shipped, all green (commits 937c5dc→6d5af88).** Remaining = needs-James (integrations keys/scopes, M2/M4 budget), redundant (M3, 8.5), or careful big-file/write-path work.
